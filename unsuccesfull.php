...
<div class="card mt-50">
    ...
    <div class="nav" style="height: 80px;">
        <ul class="mx-auto">
            <li class=""><a href="#">Ödeme Yap</a></li>
            <li class="active"><a href="#">Ödeme Red</a></li>
        </ul>
    </div>
    <center>
        <img src="https://teak.wihardja.com.sg/20191129013853/unsuccessful-logo-01.png" width="134px" height="128px">
        <p style="color: red;font-weight: bold;">Ödeme Başarısız</p>
        <p>#ABC123ABC Numaralı siparişiniz başarısız olmuştur.</p>
        <p>Yardım ve destekler için <b>sales@example.com</b> adresinden iletişim kurabilirsiniz.</p>
        <br><br>
        <p><?php
